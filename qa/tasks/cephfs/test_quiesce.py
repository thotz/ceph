...
class QuiesceTestCase(CephFSTestCase):
    ...
    def _verify_quiesce(self, rank=0, root=None, splitauth=None, status=None):
        ...
        try:
            return self._verify_quiesce_wrapped(rank, status, root_inode, ops, cache, splitauth)
        except:
            self._make_archive()
    ...
    def _verify_quiesce_wrapped(self, rank, status, root_inode, ops, cache, splitauth):
        quiesce_inode_ops = {}
